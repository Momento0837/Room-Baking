...
$(document).ready(function(){
    ...
    $('.css').on("mouseover", function() {
        $(this).stop().animate({ width: '20.5%', height: '25.5%', left: '29.75%', top: '45.5%' }, mid, 'easeOutQuad');
    }).on("mouseout", function() {
    ...
    setInterval(function(){
        $(".html").stop().animate({ width: '30.5%', height: '100.5%' }, long, 'easeOutQuad');
        setTimeout(() => {
            $(".html").stop().animate({ width: '30%', height: '100%' }, long, 'easeOutQuad');
        }, 1000);
    }, 2000);

    setInterval(function(){
        $(".css").stop().animate({ width: '20.5%', height: '25.5%', left: '29.75%', top: '45.5%' }, long, 'easeOutQuad');
        setTimeout(() => {
            $(".css").stop().animate({ width: '20%', height: '25%', left: '30%', top: '46%' }, long, 'easeOutQuad');
        }, 1000);
    }, 2000);
